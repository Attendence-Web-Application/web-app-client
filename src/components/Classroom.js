  ...
  return (
    ...
    >
      <div className="card-body">
        ...
        <h5 className="card-subtitle" style={{ paddingBottom: 10 + 'px' }}>
          {title}
        </h5>
        {isStudent && (
          <h5 className="card-subtitle">Instructor: {userData[user_id]}</h5>
        )}
      ...
      <Dialog open={open} onClose={!open || handleToDelete}>
        ...
        <DialogContent className={classes.alignItemsAndJustifyContentTitle}>
          <DialogContentText
            className={classes.alignItemsAndJustifyContentText}
          >
        ...
        <DialogActions className={classes.alignItemsAndJustifyContentButton}>
          <Wrapper>
            <div className="del_classroom_button_div">
              <button className="form-btn left" onClick={handleToDelete}>
                DELETE
              </button>
              <button
