...
export const FIND_CLASS_ID_URL =
  BASE_URL + '/class_enrolled/getClassEnroll/user'
...
export const FIND_ALL_STUDENT_BY_CLASS_ID =
  BASE_URL + '/class_enrolled/getClassEnroll/class'
